...
class InformationJobAddPage extends StatefulWidget {
  final MyUser currentUser;
  final VoidCallback getSignInStatus;

  InformationJobAddPage({this.currentUser, this.getSignInStatus, Key key})
      : super(key: key);

  @override
  _InformationJobAddPageState createState() => _InformationJobAddPageState();
}
...
class _InformationJobAddPageState extends State<InformationJobAddPage> {
