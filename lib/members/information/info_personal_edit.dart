...
class InformationPersonalEditPage extends StatefulWidget {
  final MyUser currentUser;
  final VoidCallback getSignInStatus;
  InformationPersonalEditPage({this.currentUser, this.getSignInStatus, Key key})
      : super(key: key);

  @override
  _InformationPersonalEditPageState createState() =>
      _InformationPersonalEditPageState();
}

class _InformationPersonalEditPageState
    extends State<InformationPersonalEditPage> {
  ...
  loadFormUserInformation() {
    prsFirstNameController.text = widget.currentUser.prsFirstName;
    prsMiddleNameController.text = widget.currentUser.prsMiddleName;
    prsFamilyNameController.text = widget.currentUser.prsFamilyName;
    prsFullEnglishNameController.text = widget.currentUser.prsFullEnglishName;
    prsBirthDayController.text =
        timestampTodate(widget.currentUser.prsBirthDay).toString();
    prsHomeAddressController.text = widget.currentUser.prsHomeAddress;
    prsPOBoxController.text = widget.currentUser.prsPOBox;
    prsZipCodeController.text = widget.currentUser.prsZipCode;
    prsTelephoneController.text = widget.currentUser.prsTelephone;
    prsEmailController.text = widget.currentUser.prsEmail;
    prsInstagramController.text = widget.currentUser.prsInstagram;
    prsTwitterController.text = widget.currentUser.prsTwitter;
    prsHobbiesController.text = widget.currentUser.prsHobbies;

    setState(() {
      prsMaritalStatusController = widget.currentUser.prsMaritalStatusId;
      prsCityController = widget.currentUser.prsCityId;
      prsNationalityController = widget.currentUser.prsNationalityId;
      // isLoading = false;
                  ...
                  Padding(
                    ...
                    child: DropdownButtonFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'الحالة الإجتماعي' + ' / ' + 'Marital Status',
                      ),
