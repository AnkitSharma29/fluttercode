...
class InformationExtAddPage extends StatefulWidget {
  final MyUser currentUser;
  final VoidCallback getSignInStatus;

  InformationExtAddPage({this.currentUser, this.getSignInStatus, Key key})
      : super(key: key);

  @override
  _InformationExtAddPageState createState() => _InformationExtAddPageState();
}
...
class _InformationExtAddPageState extends State<InformationExtAddPage> {
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          (extComanyLogoImageFile != null)
                              ? Container(
                                  decoration: BoxDecoration(
                                    //shape: BoxShape.circle,
                                    image: DecorationImage(
                                      image: FileImage(extComanyLogoImageFile),
                                      fit: BoxFit.fill,
                                    ),
                                  ),
                                )
                          ...
                          Center(
                            child: (extComanyLogoImageController != null &&
                                    extComanyLogoImageFile == null)
                                ? Column(
                                    mainAxisAlignment:
                      ...
                      child: Stack(
                        children: <Widget>[
                          (extIdentityImageController != null)
                              ? myCachedNetworkImage(extIdentityImageController,
                                  myBorderRadius: 0.0)
                              : Container(
                                  width: 0.0,
                                  height: 0.0,
                          ...
                          (extIdentityImageFile != null)
                              ? Container(
                                  decoration: BoxDecoration(
                                    //shape: BoxShape.circle,
                                    image: DecorationImage(
                                      image: FileImage(extIdentityImageFile),
                                      fit: BoxFit.fill,
                                    ),
                                  ),
                                )
